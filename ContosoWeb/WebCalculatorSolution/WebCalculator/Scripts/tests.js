...
test("Add Test", function () {
    ...
    var expected = '30';
    equals($('#txtResult').val(), expected, 'Expected value: ' + expected + ' Actual Value: ' + $('#txtResult').val());
    expected = '0';
    equals($('#txtInput').val(), expected, 'Expected value: ' + expected + ' Actual value: ' + $('#txtInput').val());
});
